...
export const commands = {
	...
	storeRedo: () => typedError<MutationResult_Serialize, string>(__TAURI_INVOKE("store_redo")),
	...
	storeUpdateMapMeta: (id: string, patch: MapMetaPatch) => typedError<null, string>(__TAURI_INVOKE("store_update_map_meta", { id, patch })),
	...
	mapId?: string | null,
	search?: string | null,
} | null) => typedError<SeenEntry[], string>(__TAURI_INVOKE("store_seen_list", { limit, offset, filter })),
